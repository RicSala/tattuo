...
const ImageUploadControlled = ({
    ...
    const handleUpload = useCallback((result) => {
        ...
        // if value is an array, push the new image
        if (Array.isArray(value)) { onChange([...value, result.info.secure_url]) }
        // if value is a string, replace it
        else { onChange(result.info.secure_url) }
...
export default ImageUploadControlled;